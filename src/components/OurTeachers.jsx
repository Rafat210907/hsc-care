...
const OurTeachers = () => {
  ...
  return (
    <section id="ourteachers" className="relative">
      ...
      <h6  data-aos='' data-aos-duration="800" className="text-xl sm:text-2xl text-center text-secondary mb-4">
        Teachers
      </h6>
      <h2  data-aos='fade-up' data-aos-duration="900" className="text-2xl sm:text-4xl text-center font-bold mb-4 sm:mb-8">
        Meet Our Teachers
      </h2>
